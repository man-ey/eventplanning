...
public class CookieController {
    ...
    /**
     * Cookie initialisieren bei erstem besuch mit der liste an gelikten events
     * @return cookie string (leer)
     */
    @GetMapping("/")
    ...
    /**
     * Cookie initialisieren bei erstem besuch mit der liste an gedisliten events
     * @return cookie string (leer)
     */
    @GetMapping("/")
